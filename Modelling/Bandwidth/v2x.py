...
c_Bandwidths /= 1_000_000

plt.figure()
for i in range(NUM_PLOTS):
    plt.plot(c_Bandwidths, sim_outage[i], 'ko-', label=names[i], linewidth=0.5, markerfacecolor=colours[i], markersize=6)
    # plt.plot(theory[i], comms_powers, 'ko--', label="Theory = "+str(-170 + i*10) , linewidth=0.5, markerfacecolor="none", markersize=6)
plt.xlabel("Communications Bandwidth (MHz)")
plt.ylabel("Outage")
plt.yscale('log')
# plt.ylim([0, 10])
plt.xlim([400, 1000])
...
plt.figure()
for i in range(NUM_PLOTS):
    plt.plot(c_Bandwidths, sim_rate[i], 'ko-', label=names[i], linewidth=0.5, markerfacecolor=colours[i], markersize=6)
plt.xlabel("Communications Bandwidth (MHz)")
...
plt.figure()
plt.plot(c_Bandwidths, plot_pd, 'ko-', linewidth=0.5, markerfacecolor="none", markersize=6)
plt.xlabel("Communications Bandwidth (MHz)")
...
plt.figure()
plt.plot(c_Bandwidths, plot_pd_t, 'ko-', linewidth=0.5, markerfacecolor="none", markersize=6)
plt.xlabel("Communications Bandwidth (MHz)")
plt.ylabel("Probability of Detection")
plt.yscale('log')
# plt.ylim([0.1, 1])
...
plt.figure()
for i in range(NUM_PLOTS):
    plt.plot(c_Bandwidths, sim_se[i], 'ko-', label=names[i], linewidth=0.5, markerfacecolor=colours[i], markersize=6)
plt.xlabel("Communications Bandwidth (MHz)")
