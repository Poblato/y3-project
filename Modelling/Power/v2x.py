...
plt.figure()
for i in range(NUM_PLOTS):
    plt.plot(sensing_powers, sim_pd[i], 'ko-', label="Cars", linewidth=0.5, markerfacecolor="none", markersize=6)
plt.xlabel("Radar Power (W)")
plt.ylabel("Probability of Detection (Cars)")
plt.yscale('log')
# plt.ylim([0.9, 1])
plt.xlim([0, 16])
# plt.legend()
...
plt.figure()
for i in range(NUM_PLOTS):
    plt.plot(sensing_powers, vru_pd[i], 'ko-', label="VRUs", linewidth=0.5, markerfacecolor="none", markersize=6)
plt.xlabel("Radar Power (W)")
plt.ylabel("Probability of Detection (VRUs)")
plt.yscale('log')
# plt.ylim([0.9, 1])
plt.xlim([0, 16])
# plt.legend()
